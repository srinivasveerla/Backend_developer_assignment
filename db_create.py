...
'''This file must be imported in db_use.py
This file must be executed only if a new table is required to be created'''
#Assuming that no two employees have same name
#Assuming heirarcy is followed so that a manager will not be assigned as an employee of the manager's current employee
#In this solution a single table in database is created with Emp_Id, Emp_name and Manager_name
